...
static const uint8_t PIXELS_PER_BLOCK(16);
...
static const float LOGIC_RATE(60.0f); // Rate at which logic updates
static const float FRAME_RATE(60.0f); // Frame rate
...
static const float TERMINAL_VELOCITY_X(1.0f);
static const float TERMINAL_VELOCITY_X_BOOST(1.5f);
